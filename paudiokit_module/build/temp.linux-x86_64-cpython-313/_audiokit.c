...
/* 13 */ _CFFI_OP(_CFFI_OP_FUNCTION, 5), // int()(char *, struct wav_header *, float * *, uint32_t *)
/* 14 */ _CFFI_OP(_CFFI_OP_POINTER, 21), // char *
/* 15 */ _CFFI_OP(_CFFI_OP_POINTER, 27), // struct wav_header *
/* 16 */ _CFFI_OP(_CFFI_OP_NOOP, 6),
/* 17 */ _CFFI_OP(_CFFI_OP_POINTER, 29), // uint32_t *
...
/* 26 */ _CFFI_OP(_CFFI_OP_PRIMITIVE, 19), // int16_t
/* 27 */ _CFFI_OP(_CFFI_OP_STRUCT_UNION, 0), // struct wav_header
/* 28 */ _CFFI_OP(_CFFI_OP_PRIMITIVE, 20), // uint16_t
/* 29 */ _CFFI_OP(_CFFI_OP_PRIMITIVE, 22), // uint32_t
};

static int _cffi_const_ERR_OK(unsigned long long *o)
{
  int n = (ERR_OK) <= 0;
  *o = (unsigned long long)((ERR_OK) | 0);  /* check that ERR_OK is an integer */
  return n;
}

static int _cffi_const_ERR_INVALID_ARG(unsigned long long *o)
{
  int n = (ERR_INVALID_ARG) <= 0;
  *o = (unsigned long long)((ERR_INVALID_ARG) | 0);  /* check that ERR_INVALID_ARG is an integer */
  return n;
}

static int _cffi_const_ERR_IO(unsigned long long *o)
{
  int n = (ERR_IO) <= 0;
  *o = (unsigned long long)((ERR_IO) | 0);  /* check that ERR_IO is an integer */
  return n;
}

static int _cffi_const_ERR_FORMAT(unsigned long long *o)
{
  int n = (ERR_FORMAT) <= 0;
  *o = (unsigned long long)((ERR_FORMAT) | 0);  /* check that ERR_FORMAT is an integer */
  return n;
}

static int _cffi_const_ERR_OUT_OF_MEMORY(unsigned long long *o)
{
  int n = (ERR_OUT_OF_MEMORY) <= 0;
  *o = (unsigned long long)((ERR_OUT_OF_MEMORY) | 0);  /* check that ERR_OUT_OF_MEMORY is an integer */
  return n;
}

static int _cffi_const_ERR_INTERNAL(unsigned long long *o)
{
  int n = (ERR_INTERNAL) <= 0;
  *o = (unsigned long long)((ERR_INTERNAL) | 0);  /* check that ERR_INTERNAL is an integer */
  return n;
}

static ErrorCode _cffi_d_last_error_code(void)
{
  return last_error_code();
}
#ifndef PYPY_VERSION
static PyObject *
_cffi_f_last_error_code(PyObject *self, PyObject *noarg)
{
  ErrorCode result;
  PyObject *pyresult;
...
#else
#  define _cffi_f_last_error_code _cffi_d_last_error_code
#endif

static char const * _cffi_d_last_error_message(void)
{
  return last_error_message();
}
#ifndef PYPY_VERSION
static PyObject *
_cffi_f_last_error_message(PyObject *self, PyObject *noarg)
{
  char const * result;
  PyObject *pyresult;
...
static int _cffi_d_retrieve_wav_data(char * x0, struct wav_header * x1, float * * x2, uint32_t * x3)
{
  return retrieve_wav_data(x0, x1, x2, x3);
}
#ifndef PYPY_VERSION
static PyObject *
_cffi_f_retrieve_wav_data(PyObject *self, PyObject *args)
{
  ...
  if (!PyArg_UnpackTuple(args, "retrieve_wav_data", 4, 4, &arg0, &arg1, &arg2, &arg3))
    return NULL;
  ...
  Py_BEGIN_ALLOW_THREADS
  _cffi_restore_errno();
  { result = retrieve_wav_data(x0, x1, x2, x3); }
  _cffi_save_errno();
  Py_END_ALLOW_THREADS
...
_CFFI_UNUSED_FN
static void _cffi_checkfld_struct_wav_header(struct wav_header *p)
{
  /* only to generate compile-time warnings or errors */
  (void)p;
  { char(*tmp)[5] = &p->chunk_id; (void)tmp; }
  (void)((p->chunk_size) | 0);  /* check that 'struct wav_header.chunk_size' is an integer */
  { char(*tmp)[5] = &p->format; (void)tmp; }
  { char(*tmp)[5] = &p->subchunk1_id; (void)tmp; }
  (void)((p->subchunk1_size) | 0);  /* check that 'struct wav_header.subchunk1_size' is an integer */
  (void)((p->audio_format) | 0);  /* check that 'struct wav_header.audio_format' is an integer */
  (void)((p->num_channels) | 0);  /* check that 'struct wav_header.num_channels' is an integer */
  (void)((p->sample_rate) | 0);  /* check that 'struct wav_header.sample_rate' is an integer */
  (void)((p->byte_rate) | 0);  /* check that 'struct wav_header.byte_rate' is an integer */
  (void)((p->block_align) | 0);  /* check that 'struct wav_header.block_align' is an integer */
  (void)((p->bits_per_sample) | 0);  /* check that 'struct wav_header.bits_per_sample' is an integer */
  { char(*tmp)[5] = &p->subchunk2_id; (void)tmp; }
  (void)((p->subchunk2_size) | 0);  /* check that 'struct wav_header.subchunk2_size' is an integer */
}
struct _cffi_align_struct_wav_header { char x; struct wav_header y; };

static const struct _cffi_global_s _cffi_globals[] = {
  { "ERR_FORMAT", (void *)_cffi_const_ERR_FORMAT, _CFFI_OP(_CFFI_OP_ENUM, -1), (void *)0 },
  { "ERR_INTERNAL", (void *)_cffi_const_ERR_INTERNAL, _CFFI_OP(_CFFI_OP_ENUM, -1), (void *)0 },
  { "ERR_INVALID_ARG", (void *)_cffi_const_ERR_INVALID_ARG, _CFFI_OP(_CFFI_OP_ENUM, -1), (void *)0 },
...
static const struct _cffi_struct_union_s _cffi_struct_unions[] = {
  { "wav_header", 27, _CFFI_F_CHECK_FIELDS,
...
#ifdef PYPY_VERSION
PyMODINIT_FUNC
_cffi_pypyinit__audiokit(const void *p[])
{
...
#  ifdef _MSC_VER
     PyMODINIT_FUNC
#  if PY_MAJOR_VERSION >= 3
     PyInit__audiokit(void) { return NULL; }
#  else
     init_audiokit(void) { }
#  endif
#  endif
...
PyMODINIT_FUNC
PyInit__audiokit(void)
{
  return _cffi_init("_audiokit", 0x2601, &_cffi_type_context);
}
#else
PyMODINIT_FUNC
init_audiokit(void)
{
  _cffi_init("_audiokit", 0x2601, &_cffi_type_context);
}
#endif
